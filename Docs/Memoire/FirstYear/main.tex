...
\ctparttext{The study of geographical systems implies, because of their \emph{complexity}, a subtle combination of Theoretical constructions and Empirical Analysis, either in an inductive reasoning or in a didactic constitution of knowledge. This part aims to approach our subject from the theoretical and methodological point of view, and rather as a \textit{necessary foundation} shall be understood as a body of knowledge \emph{coevolving} with Empirical and Modeling Parts.} % Text on the Part 1 page describing  the content in Part 1
...
\ctparttext{This part aims at producing knowledge from the empirical analysis of case studies and from first modeling experiments.} % Text on the Part 2 page describing the content in Part 2
...
\ctparttext{Building Bricks} % Text on the Part 2 page describing the content in Part 2
