...
\bchapters{Introduction}{Introduction}
...
\bsections{Scientific Context : Complexity Has Come of Age}{Contexte Scientifique : Paradigmes de la Complexité}
...
\bsections{Interdisciplinarity}{Interdisciplinarité}
