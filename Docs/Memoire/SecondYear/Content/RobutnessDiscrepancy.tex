...
\section{A Discrepancy-based Framework to Compare Robustness between Multi-Attribute Evaluations} 
...
%%%%%%%%%%%%%%%%
\subsubsection{Implementation on Synthetic Data}
...
%%%%%%%%%%%%%%%%
\subsubsection{Application to a Real Case : Metropolitan Segregation}
...
%%%%%%%%%%%%%%%%
\subsubsection{Applicability to Real situations}
...
%%%%%%%%%%%%%%%%
\subsubsection{Validity of Theoretical Assumptions}
...
%%%%%%%%%%%%%%%%
\subsubsection{Framework Generality}
