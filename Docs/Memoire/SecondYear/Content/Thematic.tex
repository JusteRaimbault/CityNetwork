...
% décrire méthodo : errance transports ; prendre au vol situations, les écrires -> mentionner git comme support méthodo, on peut y voir stratifications successives et geneèse des idées.
