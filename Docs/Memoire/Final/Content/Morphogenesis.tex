...
% pas nécessaire et pas sur par ailleurs
%Celui-ci s'avère relativement large, ce qui suggère l'utilisation de ce type de modèle de manière fortement couplée par la suite, puisque une latitude réduite dans les corrélations statiques impliquerait une encore plus étroite pour les corrélations dynamiques.\comment[CC]{pourquoi? il faut expliquer tes conclusions car ca n'est pas evident}.
