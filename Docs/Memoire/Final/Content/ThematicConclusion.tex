...
%\comment[FL]{cela doit arriver avant gpe/prd $\rightarrow \sim$ p 43}[non on a besoin des cas empiriques]
...
% que nous avons défini comme territoires humains, \comment[FL]{?}
% plus ou moins des échelles spatiales \comment[FL]{a eviter}
...
% de restreindre la portée des entrées prises sur le sujet \comment[FL]{pas une bonne formulation, 2 est une suite logique de 1}
