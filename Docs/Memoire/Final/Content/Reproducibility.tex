...
%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\includegraphics[width=0.33\linewidth]{Figures/Reproducibility/stdView}
\hfill
\includegraphics[width=0.33\linewidth]{Figures/Reproducibility/ViewRoads}
\hfill
\includegraphics[width=0.33\linewidth]{Figures/Reproducibility/landValues_cityFinished}
