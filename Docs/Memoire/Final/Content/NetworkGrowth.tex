...
\caption[Network examples][Exemples de réseaux]{\textbf{Exemples de réseaux obtenus par les différentes heuristiques}\label{fig:networkgrowth:examples}}{\label{fig:networkgrowth:examples}}
\end{figure}
%%%%%%%%%%%%%%%%%
