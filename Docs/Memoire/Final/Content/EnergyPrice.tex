...
\caption[Mean price for counties][Prix moyen par Contés]{Map of mean price for counties, regular fuel, averaged over the whole period.\label{fig:map_price}}{Carte du prix moyen par Conté, carburant régulier, moyenne prise sur l'ensemble de la période.\label{fig:map_price}}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%
...
\caption{Regressions at the county level\label{tab:reg}}{Régressions au niveau du Conté\label{tab:reg}}
