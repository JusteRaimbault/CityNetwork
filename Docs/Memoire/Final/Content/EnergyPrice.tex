...
\vspace{-0.1cm}
\begin{center}
{% \comment[FL]{quel rapport avec la these ?}
\begin{threeparttable}
\caption[Regressions at the county level][Régressions au niveau du comté]{Regressions at the county level\label{tab:reg}}{Régressions au niveau du comté\label{tab:reg}}
