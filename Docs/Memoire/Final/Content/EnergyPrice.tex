...
\centering
\hspace{-3cm}
\includegraphics[width=0.7\textwidth]{Figures/EnergyPrice/gwr_allbest_betaincome}
\includegraphics[width=0.7\textwidth]{Figures/EnergyPrice/gwr_allbest_betapercapjobs}\\
%\includegraphics[width=0.48\textwidth]{figures/gwr_allbest_residual}
\hspace{-3cm}
\includegraphics[width=0.7\textwidth]{Figures/EnergyPrice/gwr_allbest_wage}
\includegraphics[width=0.7\textwidth]{Figures/EnergyPrice/gwr_allbest_LocalR2}
