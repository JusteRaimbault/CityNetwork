...
Un système de villes synthétiques est généré de la façon la plus simple possible : (i) un nombre de villes $N_s$ sont placées aléatoirement dans le plan euclidien\footnote{nous relâchons l'hypothèse de positionnement selon des logiques de places centrales}
