...
\begin{figure}
	...
	\caption[Empirical Lagged Correlations for French City System][Corrélations empiriques pour le système de villes français]{}{\textbf{Corrélations retardées empiriques pour le système de villes français.}\label{fig:macrocoevol:empirical}}
\end{figure}
%%%%%%%%%%%%%
