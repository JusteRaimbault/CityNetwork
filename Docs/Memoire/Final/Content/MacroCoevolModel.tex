...
\]
, c'est à dire une évolution de la matrice de distance uniquement. Dans cette logique, nous restons dans un modèle d'interaction à l'échelle macroscopique uniquement, puisqu'une spatialisation précise du réseau implique la prise en compte d'une échelle plus fine, qui permet prendre en compte la forme locale du réseau qui détermine les plus court chemins.
