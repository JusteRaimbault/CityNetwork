...
%%%%%%%%%%%%%
\begin{table}[!ht]
\caption{{\bf Summary of model parameters.}}{\textbf{Résumé des paramètres}}
...
%%%%%%%%%%%%%%%
\begin{figure}
\includegraphics[width=\textwidth]{Figures/Density/Fig5}
...
%%%%%%%%%%%%%
\begin{figure}
\includegraphics[width=\textwidth]{Figures/Density/Fig6.png}
\caption[PSE exploration][Exploration par PSE]{\textbf{PSE exploration.} Scatterplots of Moran against Entropy, with blue points obtained with LHS and red with PSE exploration. Green dashed line gives feasible lower bound.}{}
\label{fig:fig6}
\end{figure}
%%%%%%%%%%%%%
