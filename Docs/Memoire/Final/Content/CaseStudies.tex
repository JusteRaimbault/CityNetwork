...
\bpar{
A major transportation infrastructure project in the region is the bridge-tunnel closing the mouth of the Delta, linking Zhuhai and Macao to Hong-Kong (HZMB). The length of the crossing is 36.5km, what makes it an exceptional infrastructure~\cite{hussain2011hong}. The opening to traffic was delayed of several years and is finally planned for 2018\footnote{See the official website at \url{http://www.hzmb.org/cn/default.asp}.}. \cite{zhou2016medium} shows that the expected changes in accessibility patterns for the West of the Delta are relatively strong, and these can potentially induce strong bifurcations in the trajectories of cities.
}{
