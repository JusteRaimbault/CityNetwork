...
\item Méthodologie utilisée (modèle statistiques : conclusion sens causalité/signif, système d'équation, multi-agent etc.)
...
Les domaines ``a priori'' (i.e. jugés, ou plutôt préjugés sur la revue ou l'appartenance des auteurs), sont relativement équilibrés pour les disciplines majoritaires déjà identifiées : 23.9\% Transportation, 26.3\% Planning, 22.2\% Economics, 19.5\% Geography, 4.3\% physics, le reste minoritaire se répartissant entre environnement, informatique, ingénierie et biologie.

faire eventuellement plus de tod dans litérature selon ?
