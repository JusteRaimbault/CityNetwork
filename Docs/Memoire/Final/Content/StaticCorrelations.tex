...
%%%%%%%%%%%%%%%%%%
\begin{table}
\caption{}{\textbf{Relation croisées entre indicateurs de réseau et morphologiques.} Chaque relation est ajustée par une Regression Géographique Pondérée\label{tab:staticcorrelations:gwr}}
...
vcount & vcount $\sim$ entropy & 8.595512  & 0.8825783 \\
\end{tabular}
\end{table}
%%%%%%%%%%%%%%%%%%
