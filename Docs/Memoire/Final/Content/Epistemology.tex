...
portugali semantic information



\paragraph{Knowledge production}{Production de connaissances}

Nous avons à présent la matière suffisante pour en venir à la réflexivité. Il se trouve que la production de connaissances se trouve à l'intersection des trois interactions développées ci-dessus. 
...
\cite{read2009innovation} when society produces info about society : Reflexivity ! // retional evolution proposée par Denise ?
