...
Cette dernière question est aussi à mettre en perspective avec le problème de l'existence d'émergence forte dans les structures sociales, qui en terme sociologiques correspond à l'idée de l'existence ``d'êtres sociaux''.

\comment{existence ou non d'emergence forte dans les phenomenes anthropo-sociaux ? literature socio}
...
Le concept a été utilisé en sociologie et disciplines satellites comme les études de l'organisation. 
...
% glissement vers les territoires
...
\cite{ter2011co} modélise le système des entreprises, des industries et de leur réseau dans l'espace.
...
En agronomie, \cite{sheeren2015coevolution} parle de co-évolution du paysage et des activités agricoles, mais ne désigne en fait pas d'effet circulaires de l'un sur l'autre. A priori, l'évolution des pratiques agricoles entraine une évolution du paysage.



\paragraph{Physics}{Physique}

Le terme de co-évolution a également été emprunté par la physique

\cite{hopkins2008cosmological} (only in title ?)
\cite{2016arXiv160703186A} coupled oscillators
