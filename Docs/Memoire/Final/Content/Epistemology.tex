...
evolutionnary eco geo :
\cite{colletis2010co} : territoires et technologie
\cite{ter2011co} firms industries et reseaux
\cite{schamp201020} epistemo coevol in evol eco geography


biology :
\cite{dybdahl1996geography} spatial distrib of coevol patterns
...
agronomie :
\cite{sheeren2015coevolution} paysage et activités agricoles
