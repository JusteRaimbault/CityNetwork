...
\comment[AB]{Phrase diderot - NB : a la fin de ta these je te suggere de revenir a cette phrase car au fond ta ``definition'' de coevolution ne fait pas vraiment echo a cette phrase : il faudra le dire, comme pistes de recherche.}[si quand meme : voir def coevol multiscalaire. apres en effet on ne fait pas de modeles multiscalaire et donc pas la composante lente de l'evol - mais quand meme modeles temps long non stationnaires !]
