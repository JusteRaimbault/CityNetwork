...
``\textit{Quel compromis sur les objets et échelles sont réalisés lors de la création d'un modèle de simulation ?}'' Cette question \footnote{Voir l'appel à communication à \url{https://cist2018.sciencesconf.org/resource/page/id/22}}
