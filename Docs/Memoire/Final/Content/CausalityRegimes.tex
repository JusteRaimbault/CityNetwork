...
\]
%.\comment[FL]{pourquoi écrire cette formule ?}[(JR) important pour spécifier les différentes dimensions]
...
\bpar{}{
Pour résumer la structure de la méthode et l'enchainement des traitements effectués, nous proposons le schéma dans l'encadré~\ref{frame:causalityregimes:regimes} ci-dessous.
}
...
\medskip
\framecaption{}{\textbf{Illustration des situations possibles dans le cas de deux variables.}\label{frame:causalityregimes:twovars}}
\end{mdframed}
\end{figure}
%%%%%%%%%%%%%
