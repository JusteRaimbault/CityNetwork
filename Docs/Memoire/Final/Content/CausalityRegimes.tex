...
\begin{figure}
	...
	\caption[Auto-regressive time-series][Séries temporelles auto-régressives]{}{\textbf{Estimation des régimes de corrélation dans le cas de séries temporelles auto-régressives linéaires.} Résultats de la méthode de classification des régimes pour des processus AR simples. (\textit{Gauche}) Valeur des coefficients $(a_1,a_2)$, la couleur donnant le cluster obtenu ; (\textit{(Droite)}) Trajectoires de centroïdes correspondants.\label{fig:causalityregimes:arma}}
\end{figure}
%%%%%%%%%%%%%
