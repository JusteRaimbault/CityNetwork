...
\medskip
\noun{Encadré : } \textbf{Structure de la méthodologie.} On part d'un champ stochastique dans le temps et l'espace. Un certain nombre de ses réalisations sont capturées, et mesurées sur des unités spatiales
\end{mdframed}
\end{figure}
%%%%%%%%%%%%%


Avant de nous plonger dans l'exploration empirique de la méthode, donnons-en une vision intuitive pour mieux comprendre son lien avec la co-évolution. L'encadré ci-dessous synthétise de manière stylisée des situation idéales pouvant se produire dans le cas de deux variables.
...
\includegraphics[width=\textwidth]{Figures/Theory/causality_regimes}
\medskip
\noun{Encadré : } \textbf{Illustration des situations possibles dans le cas de deux variables.}
\end{mdframed}
\end{figure}
%%%%%%%%%%%%%
