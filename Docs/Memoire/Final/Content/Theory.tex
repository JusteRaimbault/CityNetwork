...
Nous ferons pour cela l'hypothèse fondamentale, déjà introduite en chapitre~\ref{ch:thematic}, que les réseaux réels sont des éléments nécessaires des systèmes territoriaux.
}
...
\todo{sur la coevolution : beware of biological // : faire ref au 3.3.2, Monod}
