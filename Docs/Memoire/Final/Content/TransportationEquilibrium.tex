...
%%%%%%%%%%%%%%%%%%%%%
\subsection{Data collection}{Collecte des données}

%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Dataset Construction}{Construction du jeu de données}
...
%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Data Summary}{Description des données}
...
%%%%%%%%%%%%%%%%%%%%%%
\subsection{Methods and Results}{Méthodes and Résultats}



%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Visualization of spatio-temporal congestion patterns}{Visualisation des motifs spatio-temporels de congestion}
...
%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Spatio-temporal Variability of Travel Path}{Variabilité Spatio-temporelle des Trajets}
