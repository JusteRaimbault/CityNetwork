...
\comment{(Florent) HDR Anne ?}[Florent : ?]
...
\comment[Florent]{Lu Aout 17 : Modelographie plus tard ; Faire 2 chapitres de 1,2,6 ; 3 a la fin avec chap 9 ; chap 4-2,4-3 : mal dit, on n'est pas vraiment dans la coevolution ; chap 5 hors sujet a supprimer ; Annexes : a vue de nez il y en a trop ce nest pas evident de dire a priori ce qui est en trop mais des annexes = 50\% de la these, cela fairt bizarre ; Titre des figures : bien sur a ajuster au fil de la lecturem mais ces titres semblent non explicites, il faut pouvoir les comprendre hors du contexte, a minima.}
