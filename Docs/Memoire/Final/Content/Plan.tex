...
\comment{(Florent) : biblio : apalike type ? ; revoir layout figures}
...
\comment{(Arnaud) titre : répétitif sur ``growth'' ; P7 : Paris 7 Paris Diderot}
...
% Mettre quelque part les remerciements de la grille : 
...
%  TODO -- URGENT -- (when writing comments on network growth models) : do a sort of list of processes, implied objects, etc. / or a tab , from modeling, theories and CASES STUDIES --
