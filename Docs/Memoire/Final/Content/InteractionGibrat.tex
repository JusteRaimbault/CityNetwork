...
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}[ht]
\caption[Model Parameters summary][Espace des paramètres du modèle d'interaction]{Model Parameters summary\label{tab:parameters}}{Espace des paramètres\label{tab:parameters}}
%\vspace{-1cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}[ht]
\caption[Empirical AIC values][Valeurs de l'AIC empirique]{Empirical AIC results.}{Valeurs de l'AIC empirique.\comment[FL]{pour info je n'ai pas lu en detail : masi ca m'a l'air bien ciblé}\label{tab:interactiongibrat:empiricalaic}}
