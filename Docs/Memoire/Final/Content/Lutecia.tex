...
Nous notons $Z^{\ast}_i(S_1,S_2)$ l'infrastructure optimale 
}
...
\multirow{5}{*}{Usage du sol}& $\lambda$ & Portée de l'accessibilité & Accessibilité & $]0;1]$ & $0.001$ \\\cline{2-6}
 ...
 & $\beta$ & Discrete choice exponent & \multirow{2}{*}{Relocation} & $[0;+\infty]$ & $1$ \\\cline{2-3}\cline{5-6}
...
& $\lambda$ & Accessibility distance decay & Commuting range & $[0;+\infty [$ & $5$ \\
  \hline
\multirow{2}{*}{Governance} & $J$ & Collaboration cost &  & $$ & $0.001$ \\\cline{2-3}\cline{5-6}
...
Plus de détails d'implémentation sont donnés en Annexe~\ref{app:sec:}
