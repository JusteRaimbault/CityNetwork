...
\bpar{
The issue of governing Mega-city Regions is highly complex and bottom-up approaches involving self-organisation may be suitable ways to manage this complexity transparently~\cite{innes2010strategies}. 
}{
...
\item Areas building a road will enter negotiations. Possible strategies for players (negotiating areas, $i=0,1$) are : not collaborating ($NC$) and collaborating ($C$). Strategies are chosen simultaneously (non-cooperative game) as detailed below, in a probabilistic way. For $(C,NC)$ and $(NC,C)$ couples, the collaborating agent loose its investment and cannot build a road whereas the other continues his business alone. For $(NC,NC)$ both act as alone, and for $(C,C)$ a common development is done.
