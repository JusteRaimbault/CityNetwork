...
\begin{tabular}{|c|c|c|c|c|c|}
  \hline
 Sous-modèle & Paramètre & Nom & Processus & Bornes & Defaut\\
  \hline
\multirow{5}{*}{Usage du sol}& $\lambda$ & Portée de l'accessibilité & Accessibilité & $]0;1]$ & $0.001$ \\\cline{2-6}
 & $\gamma_A$ & Exposant de Cobb-Douglas actifs & Utilité & $[0;1]$ & $0.85$ \\\cline{2-6}
  & $\beta$ & Exposant de choix discrets & Relocalisation & $[0;+\infty]$ & $1$ \\\cline{2-6}
 & $\gamma_E$ & Exposant de Cobb-Douglas emplois & Utilité & $[0;1]$ & $0.85$ \\\cline{2-6}
 & $\alpha$ & Relocation rate & Relocation & $[0;1]$ & $0.05$ \\\hline
