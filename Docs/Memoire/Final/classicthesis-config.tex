...
\newcommand{\myTitle}{Modéliser la co-évolution des réseaux de transport et des territoires\xspace}
...
\newcommand{\myTime}{19 Novembre 2017\xspace}
\newcommand{\myVersion}{version 3.3.5\xspace}
