...
\begin{figure}
	...
	\appcaption{\textbf{Examples of phase diagrams of the prey-predator model.}\label{fig:app:mediationecotox:phasediags}}{\textbf{Exemples de diagrammes de phase du modèle proie-prédateur.}\label{fig:app:mediationecotox:phasediags}}
\end{figure}
%%%%%%%%%%%%
