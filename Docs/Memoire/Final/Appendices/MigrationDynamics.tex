...
%%%%%%%%%%%%%%%
\begin{figure}[h!]
\includegraphics[width=0.72\textwidth]{Figures/MigrationDynamics/model}

\includegraphics[width=0.22\textwidth]{Figures/MigrationDynamics/examples}
\appcaption{}{(Left) Multi-scale schema of processes included in the model. (Right) Examples of regional population configuration, for a synthetic city system (top) and Pearl River Delta (bottom).}
\label{fig:model}
\end{figure}
%%%%%%%%%%%%%%%
...
\includegraphics[width=0.49\textwidth,height=0.25\textheight]{Figures/MigrationDynamics/baseline_jobdist0.png}
\includegraphics[width=0.49\textwidth,height=0.25\textheight]{Figures/MigrationDynamics/real_indicjobDistance0_smoothed.png}
\appcaption{}{Comparison of average distance to jobs for the lowest economic category, as a function of the randomness parameter $\beta$, between synthetic city systems (two left plots) and real configuration (two right plots). The color gives the constant move aversion $u_i^{(c)}$ and plots are given for two values of cost-accessibility ratio $\gamma$. We witness the apparition of optimal values of $\beta$ in the real situation, probably caused by the geography.}
\label{fig:model}
\end{figure}
%%%%%%%%%%%%%%%
