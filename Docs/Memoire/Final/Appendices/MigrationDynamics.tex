...
\appcaption{}{(Left) Multi-scale schema of processes included in the model. (Right) Examples of regional population configuration, for a synthetic city system (top) and Pearl River Delta (bottom).\label{app:fig:migrationdynamics:model}}
\end{figure}
%%%%%%%%%%%%%%%
