...
\sframe{Aperçu des contributions en modélisation}{
	...
	\begin{itemize}
		\item \only<2->{\begin{mdframed}[linecolor=red]}\noindent Famille de modèles d'interaction entre villes incluant le réseau \only<2->{\end{mdframed}}
		\item Démonstration d'effets de réseau sans co-évolution
		\item Exploration des régimes d'interaction produits par le modèle co-évolutif
	\end{itemize}
	...
	\begin{itemize}
		\item Modèle de morphogenèse couplant fortement l'évolution de la forme urbaine et de celle du réseau
		\item Inclusion de multiples processus dans ce modèle, démonstration de leur complémentarité et calibration au premier et second ordre
...
\only<3->{
\psarc[linecolor=colour0, linewidth=0.04, dimen=outer, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<-}(0.57,1.18){0.38}{228.97961}{348.40784}
...
\psarc[linecolor=colour0, linewidth=0.04, dimen=outer, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<-}(6.64,-1.59){0.3}{206.56505}{345.37912}
\psline[linecolor=colour0, linewidth=0.04, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<-}(7.22,2.61)(8.04,2.61)
\rput[bl](8.16,2.45){Croissance endog{\`e}ne}
}
\only<4->{
...
\psline[linecolor=colour0, linewidth=0.04, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<->}(7.12,2.05)(8.02,2.05)
\psline[linecolor=colour0, linewidth=0.08, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<->}(3.7,-1.47)(4.62,1.53)
\rput[bl](8.18,1.99){Interaction directe}
}
\only<5->{
\psline[linecolor=colour1, linewidth=0.04, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<-}(3.38,-1.47)(3.56,-0.83)
\psline[linecolor=colour1, linewidth=0.04, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<-}(7.239434,1.6281779)(7.940566,1.6318221)
\rput[bl](8.16,1.53){R{\'e}troaction des flux}
}
\only<6->{
...
\rput{-70.90014}(2.3317764,2.455063){\psarc[linecolor=colour2, linewidth=0.08, dimen=outer, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<-}(2.89,-0.41){0.48}{229.21208}{350.33667}}
\psline[linecolor=colour2, linewidth=0.04, arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.0]{<-}(7.26,1.13)(7.96,1.13)
\rput[bl](8.14,1.03){Adaptation du r{\'e}seau}
}
\end{pspicture}
