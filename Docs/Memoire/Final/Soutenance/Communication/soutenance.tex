...
\begin{itemize}
	...
	\item \textit{Caractérisation : } nombreuses perspectives d'application\\
...
\begin{itemize}
	...
	\item \textit{Vers des théories intégrées des systèmes territoriaux : } modèles multi-échelle et couplage de la théorie évolutive avec la théorie \\
	 du \textit{Scaling}.
\end{itemize}
}
