...
Famille de modèle d'interactions dans un système de villes, basés sur les flux entre villes, incluant effets directs des flux, retroactions par les flux traversés, retroactions sur la vitesse du réseau.
...
\begin{tabular}{|l|l|l|}
\hline
Modèle Statistique & $\Delta AIC$ & $\Delta BIC$\\
\hline
Polynomial & 19.59 & 3.65\\
Log-polynomial & 125.37 & 109.43\\
Polynomial Généralisé & 11.70 & -4.23\\
\hline
\end{tabular}
...
Le modèle Lutecia : vers une intégration des processus de gouvernance 
