...
Des dynamiques \textit{co-évolutives} entre réseaux de transport et territories suggérées par la littérature
...
\begin{columns}
	\begin{column}{0.6\textwidth}
		...
		\begin{itemize}
			...
			\item Intérêt pour l'objet ville : expériences en architecture et urbanisme, puis formation
