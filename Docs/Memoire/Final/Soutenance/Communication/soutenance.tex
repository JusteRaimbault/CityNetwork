...
\begin{enumerate}
	\item {\textcolor{blue} niveau des individus}
	\item \textcolor{green} niveau des populations d'individus (niches)
...
\rput[bl](8.2,2.05){Interaction directe}
}
\only<5->{
...
\rput[bl](8.16,1.55){R{\'e}troaction des flux}
}
\only<6->{
...
\rput[bl](8.14,1.01){Adaptation du r{\'e}seau}
}
\end{pspicture}
