...
\textit{Manifestations concrètes dans le Delta de la Rivière des Perles des interactions entre transport et ville : promotion de la grande vitesse, développement urbain ciblé autour des gares.}
...
\begin{columns}
	\begin{column}{0.6\textwidth}
		...
		\begin{itemize}
			...
			\item Une transition progressive vers les sciences humaines et la géographie, tout en gardant un ancrage théorique par les systèmes complexes % geocites
		\end{itemize}
		\medskip
		
		$\rightarrow$ \textit{Une naturelle double articulation entre théorique et thématique.}
	...
	\begin{column}{0.4\textwidth}
		\centering
		\includegraphics[width=0.4\textwidth]{figures/2-gameoflife.png}\hspace{0.2cm}
		\includegraphics[width=0.4\textwidth]{figures/2-intro_RBD_lattice.png}\\
		\includegraphics[width=\textwidth]{figures/2-slimemould_reseauFinal.png}\\
		\vspace{-0.5cm}\includegraphics[width=0.8\textwidth]{figures/2-networks.jpg}
	\end{column}
...
\textbf{Axe 1 : } \textit{Construction d'une définition et d'une méthode de caractérisation empirique des ces dynamiques co-évolutives.}
...
\begin{frame}
	...
	\begin{tikzpicture}
		...
		\node (b) at (-1,0) {\includegraphics[width=2cm]{figures/4-empirical.png}};
			\node (c) at (3,5) {\includegraphics[width=3cm]{figures/4-schema.pdf}};
			\node (d) at (3,3.5) {Théorique};
			\node (e) at (7,1.5) {Modélisation};
			\node (f) at (7,0) {\includegraphics[width=3cm]{figures/4-modeling.png}};
			\draw[<->] (a) -- (d);
			\draw[<->] (d) -- (e);
			\draw[<->] (a) -- (e);
		\only<2->{
			\node (g) at (-1,5) {\textit{Méthodes}};
			\node (h) at (-1,4) {\includegraphics[width=3cm]{figures/4-methods.pdf}};
			\node (i) at (7,5) {\textit{Outils}};
			\node (j) at (7,3.8) {\includegraphics[width=3cm]{figures/4-tools.pdf}};
			\node (k) at (3,1) {\textit{Données}};
			\node (l) at (3,-0.5) {\includegraphics[width=3cm]{figures/4-data.pdf}};
		}
	\end{tikzpicture}
...
\centering
\includegraphics[width=\linewidth]{figures/4b-organisation.pdf}
...
\sframe{Perspective théoriques : définitions}{
 
  \textbf{Objets : } 
  
  \begin{itemize}
  	\item Villes et territoires lus par le prisme de la \textit{Théorie Evolutive des Villes}% (Pumain, 1997)
...
\begin{enumerate}
	\item niveau individuel d'éléments des systèmes territoriaux 
...
\begin{enumerate}
	\item Une entrée par la morphogenèse correspond à la notion de niche et l'échelle mesoscopique
...
\includegraphics[width=0.9\linewidth]{figures/6-method.pdf}
...
\begin{column}{0.5\textwidth}
	\includegraphics[width=\textwidth]{figures/7-southafrica.png}
	\smallskip
...
\vrule\hspace{0.2cm}
	...
	\includegraphics[width=\textwidth]{figures/7-grdparis.jpg}
...
\sframe{Vers une modélisation ? Cartographie des disciplines}{
	...
	\vspace{-0.5cm}
	\includegraphics[width=\linewidth]{figures/8-graph.png}
...
Famille de modèles d'interaction dans un système de villes, basés sur les flux entre villes, incluant effets directs des flux, retroactions par les flux traversés, retroactions sur la vitesse du réseau.
...
\medskip
	...
	\textit{Effets de réseau robustes au surajustement révélés par le modèle avec réseau statique}
		
\end{column}
\vrule
\hspace{0.2cm}
\begin{column}{0.3\textwidth}
	\includegraphics[width=\linewidth]{figures/9-regimes.png}
...
Relation entre forme et fonction (morphogenèse) comme paradigme pour modéliser la co-évolution à l'échelle mesoscopique.
...
{\centering
\includegraphics[width=0.3\linewidth]{figures/10-nwgrowth.png}
\includegraphics[width=0.7\linewidth]{figures/10-calib.jpg}
}
...
Un modèle de co-évolution par morphogenèse
...
\includegraphics[width=\linewidth]{figures/10-lutecia.jpg}
...
\includegraphics[width=\linewidth]{figures/11-meta.pdf}
