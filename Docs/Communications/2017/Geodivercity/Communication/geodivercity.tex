...
\hspace{-0.3cm}\includegraphics[width=0.54\textwidth]{figures/intro_paname}\hspace{0.3cm}
...
\frame{\includegraphics[width=0.31\textwidth]{figures/computation_ants}}\hspace{0.2cm}
\frame{\includegraphics[width=0.31\textwidth]{figures/computation_gameoflife}}\hspace{0.2cm}
\frame{\includegraphics[width=0.31\textwidth]{figures/computation_swarmchem}}\hspace{0.2cm}
...
$\rightarrow$ Role of new methods, tools, data (e.g. OpenMole, GarganText): \textit{Towards Integration of Knowledge Domains}
