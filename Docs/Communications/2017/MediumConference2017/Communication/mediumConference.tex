...
\sframe{Model Specification : Abstract Network}{
 ...
 \textit{Complete virtual network between cities, initialized with euclidian distances ; thresholded hierarchical growth of speeds as a function of flows.}
...
$\rightarrow$ \textit{\ldots but but with inverse deviations from a scaling law.}
...
%diversityCloseness_synthrankSize1_5_nwGmax0_05.pdf
...
%complexityAccessibility_synthrankSize1_5_nwGmax0_05.pdf
...
% laggedcorrs_gravityWeight0_00075_nwThreshold4_5.pdf
...
\footnotesize{ - All code and data available at \texttt{https://github.com/JusteRaimbault/CityNetwork/tree/master/}\\\texttt{Models/MacroCoevol}
