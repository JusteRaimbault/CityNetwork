...
model setup / stopping condition
...
\begin{enumerate}
	\item Fixed process for new nodes and connectivity
...
\frame{\includegraphics[height=0.35\textwidth]{figures/example-bio-process-1}}\hspace{0.1cm}
\frame{\includegraphics[height=0.35\textwidth]{figures/example-bio-process-1-tick80}}
...
\frame{\includegraphics[width=0.28\textwidth]{figures/example_synthsetup}}\hspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_form-accessonly}}\hspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_form-droadonly}}\\\vspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_form-bwonly}}\hspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_form-closenessonly}}\hspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_form-poponly}}
...
\frame{\includegraphics[width=0.28\textwidth]{figures/example_nw-connection}}\hspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_nw-random}}\hspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_nw-gravity}}\\\vspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_nw-rndbrkdwn}}\hspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_nw-cost}}\hspace{0.1cm}
\frame{\includegraphics[width=0.28\textwidth]{figures/example_nw-bio}}
...
%corrs-distrib_rhoasize4.png%corrs-distrib_rhoasize8.png
...
\begin{itemize}
	...
	\item Efficiency (network pace relative to euclidian 
\end{itemize}
...
Patch utility given by $U_i = \sum_k w_k \cdot \tilde{x}_k$
...
\centering
\frame{\includegraphics[width=0.42\textwidth]{figures/example_synthsetup}}\hspace{0.1cm}
\frame{\includegraphics[width=0.42\textwidth]{figures/example-realsetup}}
...
\includegraphics[width=0.45\textwidth]{figures/clustcoef}
\includegraphics[width=0.45\textwidth]{figures/diffclustcoef}
