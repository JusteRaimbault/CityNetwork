...
\begin{enumerate}
	...
	\item Variable heuristic for new links, among: nothing, random, gravity-based deterministic breakdown, gravity-based random breakdown (from~\cite{schmitt2014modelisation}), cost-benefits (from~\cite{louf2013emergence}), biological network generation (based on \cite{})
\end{enumerate}


\includegraphics[height=0.5\textheight]{figures/example-bio-process-0}
...
\textit{Comparison of feasible space for network indicators at fixed density configuration}

\medskip

\includegraphics[width=0.48\textwidth]{figures/feasible_space_withreal_pca_bymorph}
\includegraphics[width=0.48\textwidth]{figures/distance_real_bymorph}
...
\includegraphics[width=0.45\textwidth]{figures/centertrajs}
\includegraphics[width=0.45\textwidth]{figures/cluster-params}
...
\centering
\includegraphics[width=0.45]{figures/example_synthsetup}
\includegraphics[width=0.45]{figures/example-realsetup}
