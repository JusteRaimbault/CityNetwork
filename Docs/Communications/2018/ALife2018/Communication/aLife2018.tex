...
$\rightarrow$ use of grid computing, made transparent with the OpenMOLE software

\url{https://next.openmole.org/}

openmole.png

\footnotesize \textit{OpenMOLE: (i)}
...
Distribution of distances to topologies of real networks
...
$\rightarrow$ % implications for morphogenesis ?
