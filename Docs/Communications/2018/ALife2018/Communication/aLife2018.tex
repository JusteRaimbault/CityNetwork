...
\footnotesize \textit{Simulated points obtained with a LHS sampling. (Left) Feasible points cloud in a reduced network indicator space; (Right) Same points with a sample of real points}
