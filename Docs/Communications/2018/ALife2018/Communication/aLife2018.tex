...
\textit{Is city alive ? } \textbf{No}

\medskip

\textit{Is city ALife ? } \textbf{Kind of}

\medskip

$\rightarrow$ Cities (territorial systems) are morphogenetic
...
\sframe{Application: Generating optimal networks}{
...
\includegraphics[width=\textwidth]{figures/4-1-2-fig-staticcorrs-network.jpg}
...
\includegraphics[width=0.53\textwidth]{figures/7-1-2-fig-networkgrowth-realdistance.jpg}
