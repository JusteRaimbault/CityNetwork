...
\begin{itemize}
\item Mobility studied through various type of data : new data from transportation systems~\cite{o2014mining}, from Social Networks % mobility twitter
...
\includegraphics[width=\textwidth]{figures/corr_PCA_delta4}
