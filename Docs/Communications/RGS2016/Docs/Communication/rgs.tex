...
\begin{column}{0.3\textwidth}
   \textit{$\simeq 44\cdot 10^6$ links in initial OSM db, Y in first simplified layer, Z in final database}
\end{column}
\end{columns}
...
\textbf{In our case study : } Without theory, would not know which objects/measures to look at ; multi-scale and dynamical nature ; without analytics : no conclusion from empirical analysises
