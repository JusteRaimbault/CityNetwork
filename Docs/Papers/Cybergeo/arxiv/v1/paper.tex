...
\noindent\textbf{Keywords : } \textit{Citation Network; Semantic Network; Interdisciplinarity; Geography}
...
%\includegraphics[width=\textwidth]{figures/cybclic.png}
\includegraphics[width=1.6\textwidth]{Fig5.jpg}
...
\includegraphics[width=1.6\textwidth]{Fig7.jpg}
...
Larivi{\`e}re V, Gingras Y (2014) 10 measuring interdisciplinarity. Beyond
  bibliometrics: Harnessing multidimensional indicators of scholarly impact p
  187
...
\bibitem[{Morin(1986)}]{morin1986methode}
Morin E (1986) La m{\'e}thode 3. la connaissance de la connaissance. Essais,
  Seuil
...
\bibitem[{{Newman}(2013)}]{2013arXiv1310.8220N}
{Newman} MEJ (2013) {Prediction of highly cited papers}. ArXiv e-prints
  \eprint{1310.8220}
...
Raimbault J (2017) An applied knowledge framework to study complex systems.
  arXiv preprint arXiv:170609244
...
\bibitem[{{Sarig{\"o}l} et~al(2014){Sarig{\"o}l}, {Pfitzner}, {Scholtes},
  {Garas}, and {Schweitzer}}]{2014arXiv1402.7268S}
{Sarig{\"o}l} E, {Pfitzner} R, {Scholtes} I, {Garas} A, {Schweitzer} F (2014)
  {Predicting Scientific Success Based on Coauthorship Networks}. ArXiv
  e-prints \eprint{1402.7268}
