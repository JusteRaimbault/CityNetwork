...
. There are naturally ongoing debates on what is exactly interdisciplinarity (many other terms such as transdisciplinarity, crossdisciplinarity also exist) and it actually depends of involved disciplines : recent hybrid disciplines % examples from Sanders' book
% urbanism as a field ; 
