...
This is to our knowledge the first time a secondary data source is used at a large scale to study a journal not referenced in main database.
And also the combination of endogenous classifications in a multilayer fashion, using semantic information.
