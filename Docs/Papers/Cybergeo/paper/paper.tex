...
\caption{Structure of the citation network.}
...
\caption[Properties of the citation network]{Example of a maximal clique in the citation network, paper of \texttt{cybergeo} being in blue.}
\label{fig:quantepistemo:citnw}
\end{figure}
%%%%%%%%%%%%%%%%%
...
\begin{figure}
\hspace{-2cm}
\includegraphics[width=1.4\textwidth]{figures/semantic.png}
