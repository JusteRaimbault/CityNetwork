...
\cite{gerow2018measuring} : topics / citations framework
...
\comment{\cite{bouveyron2016stochastic} : topic block modeling ; similar to paper by Moore}
...
\comment{remark Marion : localisation of authors ? $\rightarrow$ we could then do spatialized networks.}
% Cointet Cambrosio https://scholar.google.fr/scholar?hl=fr&as_sdt=0%2C5&q=Cointet+cambrosio&btnG=
...
\comment{\cite{roth2010social} : coevolution socio-semantique}
