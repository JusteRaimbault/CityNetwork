...
We work with the Pumain-INED historical database for French Cities, which give populations of Urban Areas (INSEE definition)% TODO check this point
at time intervals of mostly 5 years, from 1830 to 1995. % TODO precise dates as footnote ?
The latest version of the database, described in~\cite{}% TODO data paper, does it exist ?
...
We can formalize the proposed method. Let $(X,Y)$ be the data and observations. The computational model is a function $X \mapsto M(X)$ mapping data values to a random variable. What is seen as data and parameters is somehow arbitrary
