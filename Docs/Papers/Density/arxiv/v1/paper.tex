...
\title{Calibration of a Density-based Model of Urban Morphogenesis}
\date{}
...
\newblock Cybergeo: European Journal of Geography. 2000;.
...
\newblock Universit{\'e} Paris 1 Panth{\'e}on-Sorbonne; 2014.
...
\newblock Classics in IJGIS: twenty years of the international journal of
...
\newblock In: Proceedings of the 4th International Conference on Complex
  Systems and Applications (ICCSA 2014), June 23-26, 2014, Universit{\'e} de
  Normandie, Le Havre, France; M. A. Aziz-Alaoui, C. Bertelle, X. Z. Liu, D.
  Olivier, eds.: pp. 51-60.; 2014. .
...
\bibitem{2016arXiv160806313S}
{Sheridan Dodds} P, {Rushing Dewhurst} D, {Hazlehurst} FF, {Van Oort} CM,
  {Mitchell} L, {Reagan} AJ, et~al.
\newblock {Simon's fundamental rich-gets-richer model entails a dominant
  first-mover advantage}.
\newblock ArXiv e-prints. 2016 Aug;.
...
\newblock Cybergeo: European Journal of Geography. 2006;.
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{hist_moran}\\
\includegraphics[width=0.8\textwidth]{hist_slope}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{moran_alpha}
\includegraphics[width=0.8\textwidth]{moran_beta}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{slope_alpha}
\includegraphics[width=0.8\textwidth]{slope_beta}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{distance_alpha}
\includegraphics[width=0.8\textwidth]{distance_beta}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{entropy_alpha}
\includegraphics[width=0.8\textwidth]{entropy_beta}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\textwidth]{stationary}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.49\textwidth]{pmax_alpha}
\includegraphics[width=0.49\textwidth]{pmax_logbeta}
