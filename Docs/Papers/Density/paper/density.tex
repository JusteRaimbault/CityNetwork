...
\delta t \cdot \frac{\partial p}{\partial t} = \frac{N_G \cdot p^{\alpha}}{P_{\alpha}(t)} + \frac{\beta \delta x^2}{2} \cdot \frac{\partial^2 p}{\partial x^2} + \frac{\alpha \beta \delta x^2}{2}\cdot \frac{N_G \cdot p^{\alpha-2}}{P_{\alpha}(t)} \cdot \left[ \frac{\partial^2 p}{\partial x^2} \cdot p + (\alpha - 1) \left(\frac{\partial p}{\partial x}\right)^2 \right]
\end{equation}
