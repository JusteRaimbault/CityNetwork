...
Cellular automata \cite{ward2000stochastically}
...
We sample the Parameter space using a Latin Hypercube Sampling. Parameter bounds are $\alpha \in [0.2,2],\beta \in [0,0.1],n_d \in \{0,\ldots , 4\}, N_G \in [500,3000], P_m \in [2000,100000]$. %Fig.\ref{fig:densityscatter} shows the result.
