...
% TODO : why coupled ? 
%  - interactions network territories
...
We recall here the formal definition of morphological indicators, taken from \cite{2017arXiv170806743R}. We consider gridded population data $(P_i)_{1\leq i \leq N^2}$, write $M=N^2$ the number of cells, $d_{ij}$ the distance between cells $i,j$, and $P=\sum_{i=1}^{M} P_i$ total population. We measure urban form using:
