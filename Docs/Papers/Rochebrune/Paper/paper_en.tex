...
\textbf{Mots-clés : } \textit{Synthetic Data ; Statistical Control ; Correlations ; Financial Time-series ; Land-use Transportation Interactions
%Données synthétiques ; Contrôle statistique ; Corrélations ; Séries temporelles financières ; Interactions ville-transport
}
