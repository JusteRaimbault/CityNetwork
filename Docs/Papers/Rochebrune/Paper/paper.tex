...
La méthode est testée sur un exemple de deux actifs du marché des devises (EUR/USD et EUR/GBP), sur une période de 6 mois de juin 2015 à novembre 2015.

 permettant d'obtenir un bruit sur les corrélations finales négligeable.



Le test sur une dimension plus grande doit encore être implémenté, ainsi que l'application à l'étude de la performance de modèle prédictif.
...
une généralisation de ce modèle est calibré pour des objectifs morphologiques $M$ (entropie, hiérarchie, auto-corrélation spatiale, distance moyenne) contre les valeurs réelles calculées sur l'ensemble des grilles de taille 50km extraites de la grille européenne de densité~\cite{eurostat}.
...
%%%%%%%%%%%%%%
\begin{figure}
\subfloat[][]{\includegraphics[width=0.28\textwidth]{figures/hist_crossCorMat}}
\subfloat[][]{\includegraphics[width=0.33\textwidth]{figures/heatmap_maxAbsCor}}
\subfloat[][]{\includegraphics[width=0.33\textwidth]{figures/heatmap_amplCor}}\\
\subfloat[][]{\includegraphics[width=0.33\textwidth]{figures/pca_meanAbsCor_errorBars}}
\subfloat[][]{\includegraphics[width=0.33\textwidth]{figures/pca_realDistSize_meanAbsCor}}
