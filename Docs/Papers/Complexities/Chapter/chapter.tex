...
\title{%Complexity, complexities and complex knowledge
...
\comment{idea : link with Gershenson approach through information and the juice : explicitly develop applied perspectivism ?}
