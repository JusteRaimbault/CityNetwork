...
\cite{banzhaf2016defining} reflexive programming language for open-ended evolution
...
The view of complexity we gave can be formulated as a research program, for the development of an \emph{applied perspectivism}, which has already been sketch for example by \cite{2018arXiv180807282B}.
