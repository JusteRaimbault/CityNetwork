...
%%%%%%%%%%%%%%
\begin{figure}[h!]
\includegraphics[width=0.45\linewidth]{figures/configs/1_param71861_seed0}
   \includegraphics[width=0.45\linewidth]{figures/configs/2_param71913_seed10}\\
   \includegraphics[width=0.45\linewidth]{figures/configs/3_param71918_seed0}
   \includegraphics[width=0.45\linewidth]{figures/configs/4_param71945_seed0}
