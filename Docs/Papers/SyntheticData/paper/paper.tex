...
%%% 6
\bibitem{beckman1996creating}
\begin{barticle}
\bauthor{\bsnm{Beckman}, \binits{R.J.}},
\bauthor{\bsnm{Baggerly}, \binits{K.A.}},
\bauthor{\bsnm{McKay}, \binits{M.D.}}:
\batitle{Creating synthetic baseline populations}.
\bjtitle{Transportation Research Part A: Policy and Practice}
\bvolume{30}(\bissue{6}),
\bfpage{415}--\blpage{429}
(\byear{1996})
\end{barticle}
\endbibitem
...
%%% 9
\bibitem{hoag2008synthetic}
\begin{bbook}
\bauthor{\bsnm{Hoag}, \binits{J.E.}}:
\bbtitle{Synthetic Data Generation: Theory, Techniques and Applications}.
\bpublisher{University of Arkansas},
\blocation{Ann Arbor}
(\byear{2008})
\end{bbook}
\endbibitem
...
%%% 10
\bibitem{eno2008generating}
\begin{barticle}
\bauthor{\bsnm{Eno}, \binits{J.}},
\bauthor{\bsnm{Thompson}, \binits{C.W.}}:
\batitle{Generating synthetic data to match data mining patterns}.
\bjtitle{IEEE Internet Computing}
\bvolume{12}(\bissue{3}),
\bfpage{78}--\blpage{82}
(\byear{2008})
\end{barticle}
...
%%% 13
\bibitem{birkin1988synthesis}
\begin{barticle}
\bauthor{\bsnm{Birkin}, \binits{M.}},
\bauthor{\bsnm{Clarke}, \binits{M.}}:
\batitle{Synthesis—a synthetic spatial information system for urban and
  regional analysis: methods and examples}.
\bjtitle{Environment and planning A}
\bvolume{20}(\bissue{12}),
\bfpage{1645}--\blpage{1671}
(\byear{1988})
\end{barticle}
\endbibitem

%%% 14
\bibitem{li2014differentially}
\begin{bchapter}
\bauthor{\bsnm{Li}, \binits{H.}},
\bauthor{\bsnm{Xiong}, \binits{L.}},
\bauthor{\bsnm{Jiang}, \binits{X.}}:
\bctitle{Differentially private synthesization of multi-dimensional data using
  copula functions}.
In: \bbtitle{Advances in Database Technology: Proceedings. International
  Conference on Extending Database Technology},
vol. \bseriesno{2014},
p. \bfpage{475}
(\byear{2014}).
\bcomment{NIH Public Access}
\end{bchapter}
\endbibitem
...
%%% 16
\bibitem{robin1993cross}
\begin{barticle}
\bauthor{\bsnm{Robin}, \binits{M.}},
\bauthor{\bsnm{Gutjahr}, \binits{A.}},
\bauthor{\bsnm{Sudicky}, \binits{E.}},
\bauthor{\bsnm{Wilson}, \binits{J.}}:
\batitle{Cross-correlated random field generation with the direct fourier
  transform method}.
\bjtitle{Water Resources Research}
\bvolume{29}(\bissue{7}),
\bfpage{2385}--\blpage{2397}
(\byear{1993})
\end{barticle}
\endbibitem

%%% 17
\bibitem{osborn2017multilevel}
\begin{barticle}
\bauthor{\bsnm{Osborn}, \binits{S.}},
\bauthor{\bsnm{Vassilevski}, \binits{P.S.}},
\bauthor{\bsnm{Villa}, \binits{U.}}:
\batitle{A multilevel, hierarchical sampling technique for spatially correlated
  random fields}.
\bjtitle{SIAM Journal on Scientific Computing}
\bvolume{39}(\bissue{5}),
\bfpage{543}--\blpage{562}
(\byear{2017})
\end{barticle}
\endbibitem

%%% 18
\bibitem{gourdji2010regional}
\begin{barticle}
\bauthor{\bsnm{Gourdji}, \binits{S.}},
\bauthor{\bsnm{Hirsch}, \binits{A.}},
\bauthor{\bsnm{Mueller}, \binits{K.}},
\bauthor{\bsnm{Yadav}, \binits{V.}},
\bauthor{\bsnm{Andrews}, \binits{A.}},
\bauthor{\bsnm{Michalak}, \binits{A.}}:
\batitle{Regional-scale geostatistical inverse modeling of north american co 2
  fluxes: a synthetic data study}.
\bjtitle{Atmospheric Chemistry and Physics}
\bvolume{10}(\bissue{13}),
\bfpage{6151}--\blpage{6167}
(\byear{2010})
\end{barticle}
\endbibitem

%%% 19
\bibitem{zhao2018simulation}
\begin{barticle}
\bauthor{\bsnm{Zhao}, \binits{T.}},
\bauthor{\bsnm{Wang}, \binits{Y.}}:
\batitle{Simulation of cross-correlated random field samples from sparse
  measurements using bayesian compressive sensing}.
\bjtitle{Mechanical Systems and Signal Processing}
\bvolume{112},
\bfpage{384}--\blpage{400}
(\byear{2018})
\end{barticle}
\endbibitem

%%% 20
\bibitem{benenson2004geosimulation}
\begin{bbook}
\bauthor{\bsnm{Benenson}, \binits{I.}},
\bauthor{\bsnm{Torrens}, \binits{P.}}:
\bbtitle{Geosimulation: Automata-based Modeling of Urban Phenomena}.
...
\bbtitle{The New Science of Cities}.
...
\bctitle{An evolutionary theory of urban systems}.
In: \bbtitle{International and Transnational Perspectives on Urban Systems},
...
%%% 23
\bibitem{banos2005simulating}
\begin{bchapter}
\bauthor{\bsnm{Banos}, \binits{A.}},
\bauthor{\bsnm{Chardonnel}, \binits{S.}},
\bauthor{\bsnm{Lang}, \binits{C.}},
\bauthor{\bsnm{Marilleau}, \binits{N.}},
\bauthor{\bsnm{Th{\'e}venin}, \binits{T.}}:
\bctitle{Simulating the swarming city: a mas approach}.
In: \bbtitle{Proceedings of the 9th International Conference on Computers in
  Urban Planning and Urban Management},
pp. \bfpage{29}--\blpage{30}
(\byear{2005})
\end{bchapter}
\endbibitem
...
\oauthor{\bsnm{Le~Texier}, \binits{M.}},
\oauthor{\bsnm{Le~N{\'e}chet}, \binits{F.L.}},
...
%%% 28
\bibitem{arentze2012modeling}
\begin{barticle}
\bauthor{\bsnm{Arentze}, \binits{T.}},
\bauthor{\bparticle{van~den} \bsnm{Berg}, \binits{P.}},
\bauthor{\bsnm{Timmermans}, \binits{H.}}:
\batitle{Modeling social networks in geographic space: approach and empirical
  application}.
\bjtitle{Environment and Planning A}
\bvolume{44}(\bissue{5}),
\bfpage{1101}--\blpage{1120}
(\byear{2012})
\end{barticle}
\endbibitem
...
%%% 30
\bibitem{chen2009urban}
\begin{barticle}
\bauthor{\bsnm{Chen}, \binits{Y.}}:
\batitle{Urban gravity model based on cross-correlation function and fourier
  analyses of spatio-temporal process}.
\bjtitle{Chaos, Solitons \& Fractals}
\bvolume{41}(\bissue{2}),
\bfpage{603}--\blpage{614}
(\byear{2009})
\end{barticle}
\endbibitem
...
%%% 38
\bibitem{raimbault2018multi}
\begin{bchapter}
\bauthor{\bsnm{Raimbault}, \binits{J.}}:
\bctitle{Multi-modeling the morphogenesis of transportation networks}.
In: \bbtitle{Artificial Life Conference Proceedings},
pp. \bfpage{382}--\blpage{383}
(\byear{2018}).
\bcomment{MIT Press}
\end{bchapter}
\endbibitem
...
Journal of Interdisciplinary Methods and Issues in Science. In press
(2019)
\end{botherref}
\endbibitem
...
\begin{bchapter}
\bauthor{\bsnm{Raimbault}, \binits{J.}}:
\bctitle{An urban morphogenesis model capturing interactions between networks
  and territories}.
In: \bbtitle{The Mathematics of Urban Morphology},
pp. \bfpage{383}--\blpage{409}.
\bpublisher{Springer},
\blocation{Cham}
(\byear{2019})
\end{bchapter}
...
\begin{barticle}
\bauthor{\bsnm{Chicheportiche}, \binits{R.}},
\bauthor{\bsnm{Bouchaud}, \binits{J.-P.}}:
\batitle{A nested factor model for non-linear dependencies in stock returns}.
\bjtitle{Quantitative Finance}
\bvolume{15}(\bissue{11}),
\bfpage{1789}--\blpage{1804}
(\byear{2015})
\end{barticle}
\endbibitem
