...
%%%%%%%%
% From here -> Literature survey content reused for chapter 'LUTModels' (French, EN translated, ~ 2025) => rewrite much more synthetically / content has been rewritten there -> check overlap
