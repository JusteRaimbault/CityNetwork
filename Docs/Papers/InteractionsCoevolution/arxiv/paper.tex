...
\bibitem[Colletis, 2010]{colletis2010co}
Colletis, G. (2010).
\newblock Co-{\'e}volution des territoires et de la technologie: une
  perspective institutionnaliste.
\newblock {\em Revue d'{\'E}conomie R{\'e}gionale \& Urbaine}, (2):235--249.
...
\bibitem[Janzen, 1980]{janzen1980coevolution}
Janzen, D.~H. (1980).
\newblock When is it coevolution.
\newblock {\em Evolution}, 34(3):611--612.

\bibitem[Kallis, 2007]{kallis2007coevolution}
Kallis, G. (2007).
\newblock When is it coevolution?
\newblock {\em Ecological Economics}, 62(1):1--6.
...
\bibitem[Nelson and Winter, 2009]{nelson2009evolutionary}
...
\newblock {\em Espace Populations Soci{\'e}t{\'e}s}, 11(2):269--278.

\bibitem[Raffestin, 1987]{raffestin1988reperes}
Raffestin, C. (1987).
\newblock Rep{\`e}res pour une th{\'e}orie de la territorialit{\'e} humaine.
\newblock {\em Cahier/Groupe R{\'e}seaux}, 3(7):2--22.

\bibitem[Raimbault, 2016]{raimbault2016generation}
Raimbault, J. (2016).
...
\bibitem[Raimbault, 2017d]{raimbault2017models}
Raimbault, J. (2017d).
...
\bibitem[Raimbault, 2018e]{raimbault2018modeling}
Raimbault, J. (2018e).
\newblock Modeling the co-evolution of cities and networks.
\newblock {\em Forthcoming in Handbook of Cities and Networks, Niel Z.,
  Rozenblat C., eds. arXiv:1804.09430}.

\bibitem[Raimbault, 2018f]{raimbault2018multi}
Raimbault, J. (2018f).
...
\bibitem[Raimbault, 2018g]{raimbault2018unveiling}
Raimbault, J. (2018g).
\newblock Unveiling co-evolutionary patterns in systems of cities: a systematic
  exploration of the simpopnet model.
\newblock {\em Forthcoming in Theories and Models of Urbanization, Pumain D.,
  ed. arXiv:1809.00861}.

\bibitem[Raimbault, 2018h]{raimbault2018urban}
Raimbault, J. (2018h).
\newblock An urban morphogenesis model capturing interactions between networks
  and territories.
\newblock {\em Forthcoming in Mathematics of Urban Morphogenesis, D'acci L.,
  ed., Springer Birkhauser Mathematics. arXiv:1805.05195}.
