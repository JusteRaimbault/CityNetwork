...
We proceed to a systematic exploration of the SimpopNet model \cite{schmitt2014modelisation}, which is to the best of our knowledge one of the rare initiatives to model co-evolution within a system of cities.
...
\subsubsection{Generation of synthetic configurations}
