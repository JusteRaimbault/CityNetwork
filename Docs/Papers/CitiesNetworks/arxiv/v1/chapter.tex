...
%This section aims at integrating system of cities with transportation networks in co-evolution models.
...
%\footnote{Which uses $\Delta d = \Delta t \left[ \frac{\phi^\gamma}{1 + \phi^\gamma} - d\right]$. This function yield similarly a threshold effect, since the derivative vanishes at $\phi^{\ast} = \left(\frac{d}{1 - d}\right)^{1/\gamma}$, but it can not be adjusted.}.
...
\includegraphics[width=\linewidth,height=0.9\textheight]{6-2-2-fig-macrocoevol-behavior-time.jpg}
...
%\footnote{Indeed, the entropy for the population variable gives the dispersion of the distribution of populations, and thus its decrease translate a trend to concentrate in time.}.
...
\begin{figure}
	...
	\includegraphics[width=\linewidth]{6-2-2-fig-macrocoevol-correlations.jpg}
...
\begin{figure}
	...
	\includegraphics[width=\linewidth]{6-2-3-fig-macrocoevol-slimemould}
...
\newblock {\em The Dynamics of Complex Urban Systems}, pages 373--389.
...
\bibitem[Raimbault, 2018]{raimbault2018indirect}
Raimbault, J. (2018).
\newblock Indirect evidence of networks effects in a system of cities.
\newblock {\em Environment and Planning B, in press}.
