...
% TODO Page 7: The Figure is very clear and helps a lot. However, could you specify in a unique paragraph in the text where different models or properties appear in the different equations of the model:
%- The Gibrat model
...
%
% TODO Page 9: further to technical indications, it would be great to recall the goals of the model and even in each introduction of 3.1, 3,2, to recall the main questions
...
% TODOPage 10: you speak about : “decreasing entropy, i.e. a behavior of convergence of cities trajectories in time »
...
% TODO Page 10: "Looking at the complexity of accessibility trajectories, we observe for values of 0 > 1:5 a maximum
...
% TODO Page 10: "the behavior of rank correlations for accessibility reveals that the interaction distance systematically
...
% TODO (ii) there is indeed no example in the literature in which such a link was made; 
%=> which link? could you repeat or specify?

% TODO (iii) the spectrum of dynamical regimes the model can produce will inform on the actual existence of structuring effects (direct
...
% TODO End of page 10: "A co-evolution between two variables X; Y in that sense will correspond to the existence of circular causal links X ! Y and Y ! X. We denote
%here by  [X; Y ] the lagged correlation with delay  ."
%=> does it refer to Figure 3? If yes, please indicate the figure
%

%TODO Page 13: "The exploration of profiles for  for varying parameter values suggests the existence of multiple causality regimes."
%=> please explain why?
...
% TODO Page 15: "We observe on the one hand a specific spatial scale that gives a maximum for all temporal windows, at d0 = 100km,
...
% TODO Page 20: could you repeat the initial question and explain point by point the answers?


%Figures: 
% TODO For the figures 2 to 7 : could you repeat please what means each plotted parameter ? Hence for no specialist it would be more understandable.

% TODO For the Figure 8 : could you please put a legend for cities’ colors and lines’ thickness ?
% TODO => in general, please indicate every figures in the text and explain them.
%
% TODO => for all the indexes indicated in the figures, please re-explain what they are (sometimes different of what you comment in the text, so it is confusing)
%
% TODO Please ensure that all figures will render properly when converted to grayscale.
%
%
% 
%References:
