...
\begin{itemize}
\item Network Necessity [1.2w]\medskip
\item Density Generation (paper and toy-models tests) [0.4w]\medskip
\item Biblio/Meetings/Organisation [1.2w] ; Reading Records [0.3w]\medskip
\item Cybergeo Project [1w] (ETA 1w)\medskip
