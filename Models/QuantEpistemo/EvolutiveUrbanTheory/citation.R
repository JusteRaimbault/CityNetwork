...
# raw network
edges <- read.csv('HyperNetwork/data/EvUrbTh-cit2_links.csv',sep=";",header=F,colClasses = c('character','character'))
nodesabstr <- as.tbl(read.csv('HyperNetwork/data/EvUrbTh-cit2-abstract.csv',sep=";",header=F,stringsAsFactors = F,colClasses = c(rep('character',5))))
nodes <- as.tbl(read.csv('HyperNetwork/data/EvUrbTh-cit2.csv',sep=";",header=F,stringsAsFactors = F,colClasses = c('character','character','character')))
nodesprim <-read.csv('HyperNetwork/data/EvUrbTh-cit1-grepPumainSandersBretagnolle.csv',sep=";",header=F,stringsAsFactors = F,colClasses = c('character','character','character'))
# add initial primary
