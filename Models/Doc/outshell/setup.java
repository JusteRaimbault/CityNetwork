...
* let intCent int (parAct / 100 - 10 LICENSE.md MetropolSim19.nlogo MetropolSim2.0.nlogo display.java display.nls fractal-network.java fractal-network.nls governement.java governement.nls indicators.java indicators.nls land-use.java land-use.nls listUtils.java listUtils.nls main.java main.nls networkUtils.java networkUtils.nls setup.java setup.nls transport.java transport.nls intMille)
* let intDix int (parAct / 10 - 100 LICENSE.md MetropolSim19.nlogo MetropolSim2.0.nlogo display.java display.nls fractal-network.java fractal-network.nls governement.java governement.nls indicators.java indicators.nls land-use.java land-use.nls listUtils.java listUtils.nls main.java main.nls networkUtils.java networkUtils.nls setup.java setup.nls transport.java transport.nls intMille - 10 LICENSE.md MetropolSim19.nlogo MetropolSim2.0.nlogo display.java display.nls fractal-network.java fractal-network.nls governement.java governement.nls indicators.java indicators.nls land-use.java land-use.nls listUtils.java listUtils.nls main.java main.nls networkUtils.java networkUtils.nls setup.java setup.nls transport.java transport.nls intCent)
* let intUn int (parAct - 1000 LICENSE.md MetropolSim19.nlogo MetropolSim2.0.nlogo display.java display.nls fractal-network.java fractal-network.nls governement.java governement.nls indicators.java indicators.nls land-use.java land-use.nls listUtils.java listUtils.nls main.java main.nls networkUtils.java networkUtils.nls setup.java setup.nls transport.java transport.nls intMille - 100 LICENSE.md MetropolSim19.nlogo MetropolSim2.0.nlogo display.java display.nls fractal-network.java fractal-network.nls governement.java governement.nls indicators.java indicators.nls land-use.java land-use.nls listUtils.java listUtils.nls main.java main.nls networkUtils.java networkUtils.nls setup.java setup.nls transport.java transport.nls intCent - 10 LICENSE.md MetropolSim19.nlogo MetropolSim2.0.nlogo display.java display.nls fractal-network.java fractal-network.nls governement.java governement.nls indicators.java indicators.nls land-use.java land-use.nls listUtils.java listUtils.nls main.java main.nls networkUtils.java networkUtils.nls setup.java setup.nls transport.java transport.nls intDix)
* 
