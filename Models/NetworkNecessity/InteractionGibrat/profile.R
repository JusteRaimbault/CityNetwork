...
setwd(paste0(Sys.getenv("CN_HOME"),'/Results/NetworkNecessity/InteractionGibrat/profile/nofeedback/20160607_mselog/data'))
...
for(param in params){
  ...
  g=ggplot(d,aes_string(x=param,y="mselog"))
