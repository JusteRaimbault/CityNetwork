...
*/
   ...
   *  Run the model
   */
  def run(growthRate: Double, gravityWeight: Double, gravityGamma: Double, gravityDecay: Double, gravityAlpha: Double, feedbackWeight: Double, feedbackGamma: Double, feedbackDecay: Double): Matrix = {
